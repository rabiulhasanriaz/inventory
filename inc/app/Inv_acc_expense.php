...
class Inv_acc_expense extends Model
{
   ...
   // protected $primaryKey = 'inv_abi_id';
    ...
    {
    	return Inv_acc_expense::where('inv_acc_exp_category_id',$exCatId)->where('inv_acc_exp_company_id',Auth::user()->au_company_id)->where('inv_acc_exp_status',1)->pluck('inv_acc_exp_id')->toArray();
    }
