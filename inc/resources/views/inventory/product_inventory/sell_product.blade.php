                    ...
                    <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach ($sell_pro as $sell)
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="pro_price_{{ $sell->inv_pro_det_id }}" style="width: 100px;" value="{{ $sell->inv_pro_det_sell_price }}"></td>
                                    <td>
                                        @if($sell->inv_pro_det_pro_warranty == 0)
                                        <input type="text" class="form-control" style="width: 50px;" id="pro_qty_{{ $sell->inv_pro_det_id }}" placeholder="Qty">
