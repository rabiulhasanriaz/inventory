            ...
            <section class="content-header">
                ...
                <div class="box">
                        ...
                        <div class="col-sm-12">
                          ...
                          {{ Form::open(['action' => 'Inventory\ProductBuyEditController@cartSubmit','method' => 'post' , 'class' => 'form-horizontal']) }}
                          ...
                          <a href="{{ route('buy_edit.buy-edit-pro', $pro_temps->first()->inv_pro_temp_invoice_no) }}" class="btn btn-danger pull-right" style="margin-right: 5px;">Edit</a>
