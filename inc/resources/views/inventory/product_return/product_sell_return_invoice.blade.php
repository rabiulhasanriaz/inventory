            ...
            <section class="content-header">
                ...
                <div class="box">
                        ...
                        <div class="col-sm-12">
                          ...
                          {{ Form::open(['action' => 'Inventory\ProductSellReturnController@cartSubmit','method' => 'post' , 'class' => 'form-horizontal']) }}
                          ...
                          <a href="{{ route('product_return.sell-return-view') }}" class="btn btn-danger pull-right" style="margin-right: 5px;">Edit</a>
