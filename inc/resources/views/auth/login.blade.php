...
<div class="login-box">
  <div class="login-logo">
    <a href="https://iglweb.com/web/">IGL Web Ltd</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="au_mobile" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="au_password" class="form-control" placeholder="Password">
